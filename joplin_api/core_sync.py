...
class JoplinApiSync:
    ...
    def get_notes_preview(self, **kwargs) -> Response:
        """
        GET /notes
        ...
        :return: res: result of the get
        """
        get_kwargs = urllib.parse.urlencode(kwargs)
        qs = {'query_string': get_kwargs}
        return self.query('get', '/notes/', self.preview_note_props, **qs)
    ...
    def get_notes(self, **kwargs) -> Response:
        ...
        get_kwargs = urllib.parse.urlencode(kwargs)
        qs = {'query_string': get_kwargs}
        return self.query('get', '/notes/', self.note_props, **qs)
    ...
    def get_paged_folders(self, limit, page) -> Response:
        """
        GET /folders
    ...
    def search_paged(self, query, page=1, limit=100, item_type='note', field_restrictions='' ) -> Response:
        """
        Call GET /search?query=YOUR_QUERY to search for notes.
        This end-point supports the field parameter which is recommended to use
        so that you only get the data that you need.
